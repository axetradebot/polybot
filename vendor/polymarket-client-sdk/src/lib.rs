...
// V2 Polymarket exchange addresses (April 2026 migration).
// Polygon mainnet collateral is pUSD, the new ERC-20 that replaces USDC.e.
// Source: https://docs.polymarket.com/v2-migration and /resources/contracts
